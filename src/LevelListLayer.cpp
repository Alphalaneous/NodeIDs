...
$register_ids(LevelListLayer) {
    ...
    rightSideMenu->setPosition(winSize.width - 25.f GEODE_IOS(- geode::utils::getSafeAreaRect().getMinX()), winSize.height / 2);
...
struct LevelListLayerIDs : Modify<LevelListLayerIDs, LevelListLayer> {
    ...
    void createLeftMenu() {
        ...
        leftSideMenu->setPosition(26.f GEODE_IOS(+ geode::utils::getSafeAreaRect().getMinX()), winSize.height / 2);
