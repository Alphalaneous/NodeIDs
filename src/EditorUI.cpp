...
$register_ids(EditorUI) {
    ...
    if (auto menu = this->getChildByType<CCMenu>(0)) {
        ...
        toolbarTogglesMenu->setPosition(
            winSize.width - 47.f GEODE_IOS(- geode::utils::getSafeAreaRect().getMinX()),
            45.f
        );
        ...
        menu->setPosition(42.f GEODE_IOS(+ geode::utils::getSafeAreaRect().getMinX()), 45.f);
    ...
    if (auto menu = this->getChildByType<CCMenu>(3)) {
        ...
        rightMenu->setPosition(
            winSize.width - 210.f / 2 GEODE_IOS(- geode::utils::getSafeAreaRect().getMinX()),
        ...
        layerMenu->setPositionX(winSize.width - 110.f / 2 - 6.f GEODE_IOS(- geode::utils::getSafeAreaRect().getMinX()));
